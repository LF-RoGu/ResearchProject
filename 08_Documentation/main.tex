...
\author{\IEEEauthorblockN{1\textsuperscript{st} Luis Fernando Rodriguez Gutierrez}
...
\IEEEauthorblockN{2\textsuperscript{th} Leander Hackmann}
\IEEEauthorblockA{\textit{Fachhochschule Dortmund} \\
\textit{M.Eng. Embedded Systems Engineering}\\
