...
%%Figures~\ref{fig:pointcloud_unaligned} and~\ref{fig:pointcloud_aligned} 
illustrate the effect of this calibration step, showing the raw unaligned point clouds compared to the corrected and merged representation. 
The transformed data provided a coherent input for the odometry estimation pipeline, ensuring that static landmarks were consistently aligned across both sensors. 
